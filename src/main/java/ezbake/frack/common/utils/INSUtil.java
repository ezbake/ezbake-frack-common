...
public class INSUtil {
     ...
     * the set of topics to which the given feed will be broadcasting.
     *
    ...
    public static INSInfo getINSInfo(Pipeline pipeline, String feedName) {
        ...
        try {
            ...
            return new INSInfo(topics, prefix);
        } catch (TException e) {
    ...
    public static class INSInfo implements Serializable {
        ...
        public Set<String> getNonSystemTopics() {
            return Sets.filter(topics, new Predicate<String>() {
                @Override
                public boolean apply(String input) {
                    return !input.equals("SSR");
                }
            });
        }
